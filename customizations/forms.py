...
aion_validator = validators.Regexp(regex='^.*@aion.network$',message='INVALID_EMAIL_ADDRESS')
...
class UniqueEmailFormMixin():
    email = StringField(
        get_form_field_label('email'),
        validators=[email_required, email_validator, unique_user_email, aion_validator])

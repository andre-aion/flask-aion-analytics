...
def register():
    try:
        ...
        if form.validate_on_submit():
            ...
            return render_template('security/two-factor/register.html', form=form)
    except Exception:
...
def set_qrcode():
    try:
        ...
        return render_template('security/two-factor/two-factor-setup.html', qr_code='/static/images/qr_code.png')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('index'))
    return render_template('security/two-factor/login.html', form=form)
...
def index():
    ...
    return render_template('security/two-factor/templates/index.html', script=script, template="Flask")
